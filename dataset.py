...
class Dataset_PSDM_train(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        Mask_Brainstem = np.load(os.path.join(file_dir, 'Brainstem', file_name))[:, :, np.newaxis]
        Mask_Esophagus = np.load(os.path.join(file_dir, 'Esophagus', file_name))[:, :, np.newaxis]
        Mask_Larynx = np.load(os.path.join(file_dir, 'Larynx', file_name))[:, :, np.newaxis]
        Mask_LeftParotid = np.load(os.path.join(file_dir, 'LeftParotid', file_name))[:, :, np.newaxis]
        Mask_Mandible = np.load(os.path.join(file_dir, 'Mandible', file_name))[:, :, np.newaxis]
        Mask_possible_dose_mask = np.load(os.path.join(file_dir, 'possible_dose_mask', file_name))[:, :, np.newaxis]
        Mask_PTV56 = np.load(os.path.join(file_dir, 'PTV56', file_name))[:, :, np.newaxis]
        Mask_PTV63 = np.load(os.path.join(file_dir, 'PTV63', file_name))[:, :, np.newaxis]
        Mask_PTV70 = np.load(os.path.join(file_dir, 'PTV70', file_name))[:, :, np.newaxis]
        Mask_RightParotid = np.load(os.path.join(file_dir, 'RightParotid', file_name))[:, :, np.newaxis]
        Mask_SpinalCord = np.load(os.path.join(file_dir, 'SpinalCord', file_name))[:, :, np.newaxis]
